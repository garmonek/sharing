...
final class Version20200407192641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE exchange_request (id INT AUTO_INCREMENT NOT NULL, target_id INT NOT NULL, user_id INT NOT NULL, message VARCHAR(255) DEFAULT NULL, INDEX IDX_7C5D591E158E0B66 (target_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE exchange_request ADD CONSTRAINT uc_user_id_target_id UNIQUE (user_id, target_id)');
