...
final class Version20200314225321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer_exchange_tags (tag_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_556E7BFBAD26311 (tag_id), UNIQUE INDEX UNIQ_556E7BF53C674EE (offer_id, tag_id), PRIMARY KEY(tag_id, offer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
